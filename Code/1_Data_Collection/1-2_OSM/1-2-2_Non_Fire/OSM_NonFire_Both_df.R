...
df1 <- content(NonFire_Both_OSM_2019_1, "text")
# tidy the text
...
df1 <- content(NonFire_Both_OSM_2019_2, "text")
df1 <- grep("^/\\* [0-9]* \\*/", df1, value = TRUE, invert = TRUE)
n1 <- length(df1)
df1[-n1] <- gsub("^}$", "},", df1[-n1])
df1 <- c("[", df1, "]")
...
df1 <- content(NonFire_Both_OSM_list[[1]], "text")
df1 <- grep("^/\\* [0-9]* \\*/", df1, value = TRUE, invert = TRUE)
n1 <- length(df1)
df1[-n1] <- gsub("^}$", "},", df1[-n1])
df1 <- c("[", df1, "]")
...
df2 <- content(NonFire_Both_OSM_list[[2]], "text")
...
df3 <- content(NonFire_Both_OSM_list[[3]], "text")
...
df4 <- content(NonFire_Both_OSM_list[[4]], "text")
...
df5 <- content(NonFire_Both_OSM_list[[5]], "text")
...
df6 <- content(NonFire_Both_OSM_list[[6]], "text")
...
df7 <- content(NonFire_Both_OSM_list[[7]], "text")
...
df8 <- content(NonFire_Both_OSM_list[[8]], "text")
...
df9 <- content(NonFire_Both_OSM_list[[9]], "text")
...
df10 <- content(NonFire_Both_OSM_list[[10]], "text")
...
df11 <- content(NonFire_Both_OSM_list[[11]], "text")
...
df12 <- content(NonFire_Both_OSM_list[[12]], "text")
