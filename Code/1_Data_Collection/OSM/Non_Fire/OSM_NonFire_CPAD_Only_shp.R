...
df1 <- anti_join(df1, Fire_CPAD_Only_OSM_df, by = c("@osmId" = "X.osmId", "@version" = "X.version"))
...
df2 <- anti_join(df2, Fire_CPAD_Only_OSM_df, by = c("@osmId" = "X.osmId", "@version" = "X.version"))
...
df3 <- anti_join(df3, Fire_CPAD_Only_OSM_df, by = c("@osmId" = "X.osmId", "@version" = "X.version"))
...
df4 <- anti_join(df4, Fire_CPAD_Only_OSM_df, by = c("@osmId" = "X.osmId", "@version" = "X.version"))
...
df5 <- anti_join(df5, Fire_CPAD_Only_OSM_df, by = c("@osmId" = "X.osmId", "@version" = "X.version"))
...
df6 <- anti_join(df6, Fire_CPAD_Only_OSM_df, by = c("@osmId" = "X.osmId", "@version" = "X.version"))
...
df7 <- anti_join(df7, Fire_CPAD_Only_OSM_df, by = c("@osmId" = "X.osmId", "@version" = "X.version"))
...
df8 <- anti_join(df8, Fire_CPAD_Only_OSM_df, by = c("@osmId" = "X.osmId", "@version" = "X.version"))
...
df9 <- anti_join(df9, Fire_CPAD_Only_OSM_df, by = c("@osmId" = "X.osmId", "@version" = "X.version"))
...
df10 <- anti_join(df10, Fire_CPAD_Only_OSM_df, by = c("@osmId" = "X.osmId", "@version" = "X.version"))
...
df11 <- anti_join(df11, Fire_CPAD_Only_OSM_df, by = c("@osmId" = "X.osmId", "@version" = "X.version"))
...
df12 <- anti_join(df12, Fire_CPAD_Only_OSM_df, by = c("@osmId" = "X.osmId", "@version" = "X.version"))
