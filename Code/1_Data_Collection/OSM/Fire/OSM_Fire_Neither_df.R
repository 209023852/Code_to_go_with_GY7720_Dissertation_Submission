...
#Fire_Neither_Bounds_OSM <- Fire_Neither[1,] %>%
#  sf::st_bbox()
#Fire_Neither_Bounds_OSM <- c(Fire_Neither_Bounds_OSM[[3]],
#                                Fire_Neither_Bounds_OSM[[2]],
#                                Fire_Neither_Bounds_OSM[[1]],
#                                Fire_Neither_Bounds_OSM[[4]])
#
#Fire_Neither_Bounds_OSM
