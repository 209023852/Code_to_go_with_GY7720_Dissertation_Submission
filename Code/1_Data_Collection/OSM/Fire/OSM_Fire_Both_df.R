...
#Fire_Both_Bounds_OSM <- Fire_Both[1,] %>%
 # sf::st_bbox()
#Fire_Both_Bounds_OSM <- c(Fire_Both_Bounds_OSM[[3]],
 #                            Fire_Both_Bounds_OSM[[2]],
 #                            Fire_Both_Bounds_OSM[[1]],
 #                            Fire_Both_Bounds_OSM[[4]])

#Fire_Both_Bounds_OSM
